    ...
    return `
      ...
      <footer class="text-center text-lg-start text-white mt-5" style="background: linear-gradient(to right,#4FC3F7,#1976D2);">
          ...
          <div class="p-4" style="text-align: left;">
              ...
              <div class="row my-4">
                  ...
                  <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                      ...
                      <ul class="list-unstyled">
                          <li>
                              <p><i class="fas fa-map-marker-alt pe-2 mr-2"></i>Casisang, Malabalay, Bukidnon</p>
                          </li>
                          <li>
                              <p><i class="fas fa-phone pe-2 mr-2"></i>+ 01 234 567 89</p>
                          </li>
                          <li>
                              <p><i class="fas fa-envelope pe-2 mb-0 mr-2"></i>waggingtails@gmail.com</p>
                          </li>
                      </ul>
                  </div>
                  <!--Grid column-->
          ...
          <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
              © 2023 Copyright:
              <a class="text-white" href="#">Wagging_Tails.com</a>
          </div>
          <!-- Copyright -->
      </footer>
      `;
